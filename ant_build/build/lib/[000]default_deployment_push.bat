...
%dir%..\..\curl\curl -X DELETE -H "Authorization:Bearer %rancherApiKey%" -H "Content-Type: application/yaml" -T "%dir%..\..\yml_k8s\del.yml" %rancherApiUrl%/apis/apps/v1beta1/namespaces/%k8sNamespace%/deployments/%k8sName%
echo ----------------------------------------------------------------------------------------------------
...
%dir%..\..\curl\curl -X DELETE -H "Authorization:Bearer %rancherApiKey%" -H "Content-Type: application/yaml" -T "%dir%..\..\yml_k8s\del.yml" %rancherApiUrl%/api/v1/namespaces/%k8sNamespace%/services/%k8sName%
echo ----------------------------------------------------------------------------------------------------
